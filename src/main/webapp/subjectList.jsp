...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="subject/list" method="post" rel=”pagerForm”>
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="subjectAdd.jsp" target="dialog" width="350"><span>添加</span></a></li>
			<li class="line">line</li>
			<li><a class="delete" href="subject/delete/{e_id}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li class="line">line</li>
