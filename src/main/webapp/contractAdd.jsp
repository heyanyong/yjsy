	...
	<form method="get" action="contract/save"
		...
		<div class="pageFormContent" layoutH="56">
			...
			<div class="panel collapse" minH="100" >
				<h1>药品明细 <span class="addRowt"   onclick="addRow('contractAddsub');">添加行<b>+</b></span><span class="delRowt" onclick="removeRow('contractAddsub');">删除行-</span></h1>
				<div>
					<table class="editTable" id="contractAddsub">
							<thead>
								<tr>
									<th>&nbsp;</th>
									<th>编号</th>
