...
<div class="pageContent">
	<form method="get" id="billForm" action="contract/update"
		...
		<div class="pageFormContent" layoutH="56">
			<p>
				...
				<input name="id" id="billId" type="hidden" value="${info.id}"/>
			</p>
			<p>
			...
			<p>
				<label>需求单编号：</label> <input name="purchaseNo" value="${info.purchaseNo}" type="text" 
					size="30" />
			</p>
			<p>
			...
			<div class="panel collapse" minH="100" >
				<h1>药品明细 <span class="addRowt"   onclick="addRow('contractEditsub');">添加行<b>+</b></span><span class="delRowt" onclick="removeRow('contractEditsub');">删除行-</span></h1>
				<div>
					<table class="editTable" id="contractEditsub">
							<thead>
								<tr>
									<th>&nbsp;</th>
									<th>编号</th>
...
<script type="text/javascript">
  if($("#billId").val()==''||$("#billId").val()==null){
	$("#billForm").attr("action","contract/save");
